...
My main languages are JavaScript, Python, and C#. I especially enjoy the
JavaScript ecosystem, and I have experience with React, NestJS, FastAPI,
.NET, PostgreSQL, Prisma, and TypeORM. I prefer feature work first and bug
fixes second, especially on the backend; after that, I prefer frontend work,
documentation, and then tests. I work on a Mac, so I want to avoid issues that
depend on Windows or another specific operating system, although cross-platform
C# issues are welcome. I prefer small or medium, manageable codebases, but I am
open to a larger codebase when the issue is a good fit.
